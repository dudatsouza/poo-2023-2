...
public class Consultorio { 
	...
	public Medico procurarMedico (int crm) throws ExcecaoMedicoInexistente{
		if (medicos.isEmpty()) throw new ExcecaoMedicoInexistente("A LISTA DE MEDICOS ESTA VAZIA.\n");
	    else {
	...
	public Paciente procurarPaciente (String cpf) throws ExcecaoPacienteInexistente{
		if (pacientes.isEmpty()) throw new ExcecaoPacienteInexistente("A LISTA DE PACIENTES ESTA VAZIA.\n");
	    else {
	...
	public Consulta procurarConsulta (String data, String hora, String cpfPaciente, int crmMedico) throws ExcecaoConsultaInexistente{
		if (pacientes.isEmpty()) throw new ExcecaoConsultaInexistente("A LISTA DE CONSULTAS ESTA VAZIA.\n");
	    else {
		...
		throw new ExcecaoConsultaInexistente("\n- CONSULTA NAO ENCONTRADO!");
	}
	...
	public Pessoa cadastrarPessoa () {
        ...
        while (true) {
            try {
                ...
                if (aux > 0) System.out.println(e.getMessage());
	...
	public void cadastrarMedico () {
		if (medicos.size() >= 5) {
			System.out.println("\n- NAO E POSSIVEL CADASTRAR MAIS MEDICOS! O LIMITE FOI ATINGIDO!");
			return;
		} else {
	...
	public void cadastrarPaciente () {
		if (pacientes.size() >= 100) {
			System.out.println("\n- NAO E POSSIVEL CADASTRAR MAIS PACIENTES! O LIMITE FOI ATINGIDO!");
			return;
		} else {
			Pessoa pessoa = cadastrarPessoa();
	...
	public void cadastrarConsulta () {
		if (consultas.size() >= 100) {
			System.out.println("\n- NAO E POSSIVEL CADASTRAR MAIS CONSULTAS! O LIMITE FOI ATINGIDO!");
			return;
		} else {
	...
	public void removerMedico () throws ExcecaoMedicoInexistente {
		try {
	...
	public void removerPaciente () throws ExcecaoPacienteInexistente {
	...
	public void removerConsulta () throws ExcecaoMedicoInexistente, ExcecaoPacienteInexistente, ExcecaoConsultaInexistente {
	...
	public void alterarMedico () throws ExcecaoSexoInvalido, ExcecaoMedicoInexistente {
	...
	public void alterarPaciente () throws ExcecaoSexoInvalido, ExcecaoPacienteInexistente {
	...
	public void alterarConsulta () throws ExcecaoConsultaInexistente {
	...
	public void registrarDiagnostico () throws ExcecaoMedicoInexistente, ExcecaoPacienteInexistente, ExcecaoConsultaInexistente {
		System.out.print("Digite a data da consulta: ");
		String data = sc.nextLine();
	...
	public void imprimirMedico () throws ExcecaoMedicoInexistente {
		System.out.print("Digite o CRM do Medico: ");
		int crmMedico = sc.nextInt();
		sc.nextLine();
	...
	public void imprimirPaciente () throws ExcecaoPacienteInexistente {
		System.out.print("Digite o CPF do Paciente: ");
		String cpfPaciente = sc.nextLine();
	...
	public void imprimirConsulta () throws ExcecaoMedicoInexistente, ExcecaoPacienteInexistente, ExcecaoConsultaInexistente {
		System.out.print("Digite a data da consulta: ");
		String data = sc.nextLine();
	...
	public void imprimirConsultasDeUmMedico () throws ExcecaoMedicoInexistente {
		System.out.print("Digite o CRM do Medico: ");
		int crmMedico = sc.nextInt();
		sc.nextLine();
	...
	public void imprimirConsultasDeUmPaciente () throws ExcecaoPacienteInexistente {
		System.out.print("Digite o CPF do Paciente: ");
		String cpfPaciente = sc.nextLine();
	...
	public void consultarConsulta(Consulta c) throws ExcecaoConsultaInexistente {
